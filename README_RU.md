...
На малых файлах SEIN сопоставим с INI. На больших файлах вырывается вперёд благодаря mmap - ОС проецирует файл в память без лишнего копирования через ядро.
